...
- `wiki_<instance path>_reader` - read-only access
- `wiki_<instance path>_editor` - edit access
- `wiki_<instance path>_admin` - full access
- `wiki_<instance path>_reviewer` - QM
