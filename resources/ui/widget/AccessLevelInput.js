ext.bluespiceWikiFarm.ui.widget.AccessLevelInput = function ( cfg ) {
	...
	cfg.menu.items = [
		new OOJSPlus.ui.widget.MenuOptionWithDescription( {
			...
			disabled: cfg.enabledItems ? cfg.enabledItems.indexOf( 'public' ) === -1 : false // eslint-disable-line unicorn/prefer-includes
		} ),
		new OOJSPlus.ui.widget.MenuOptionWithDescription( {
			data: 'protected',
			label: mw.msg( 'wikifarm-ui-access-wiki-type-protected' ),
			description: mw.msg( 'wikifarm-ui-access-wiki-type-protected-help' ),
			disabled: cfg.enabledItems ? cfg.enabledItems.indexOf( 'protected' ) === -1 : false // eslint-disable-line unicorn/prefer-includes
		} ),
		new OOJSPlus.ui.widget.MenuOptionWithDescription( {
			data: 'private',
			label: mw.msg( 'wikifarm-ui-access-wiki-type-private' ),
			description: mw.msg( 'wikifarm-ui-access-wiki-type-private-help' ),
			disabled: cfg.enabledItems ? cfg.enabledItems.indexOf( 'private' ) === -1 : false // eslint-disable-line unicorn/prefer-includes
		} )
	];
